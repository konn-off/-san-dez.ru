...
$token = '07f4beb4c642def37b6ea845fb8d37e5d3505697';//'35042f12fc9bb52b979d15404ef65c2fa8ce1867';
$profile_id = '99506a75-79e8';//'95c2a15f-47f6';
      ...
      if($data[$n]['type']=='ptt' && $data[$n]['isDeleted']==NULL){
         ...
         if($conn->query($sql)){
            ...
            if($result->num_rows != 0){
               ...
               $response = file_get_contents('https://san-dez.ru/my_script/YandexGPT/index.php', false, $context);                                          
...
if($type_mes=='read'){ 
   $data=recuest_api($token,$profile_id,$url_file,$phone,$mes,$type_mes,$id_mes,$caption,$file_name,$chat_id); 
   $sql4 = "UPDATE all_leads SET dialog_wiev = 0 WHERE chat_id_tg = '".$chat_id."'"; 
   $conn->query($sql4);
}
