...
function writeToLog($data, $title = '') {
    ...
    $log .= print_r ($data,1);
    $log .= "\n------------------------\n";
    file_put_contents(getcwd() . '/hook4.log', $log, FILE_APPEND);
    return true;
}
...
$site = 'san-dez.ru';
$url = $data['extra']['open'];
$roistat = $data['cookies']['roistat_visit'];
$ycid = $data['cookies']['_ym_uid'];
...
$referrer_url = $data['extra']['referer'];
